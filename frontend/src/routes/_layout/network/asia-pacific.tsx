      ...
      <Box py={16} bg="orange.50" color="gray.800">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Mobile-First Testing</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Emerging Market Access</Heading>
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr" }} gap={10} mt={10}>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.600">1.6M+</StatNumber>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">Mobile App Developer Expands into Southeast Asia</Heading>
              <Text mb={4}>
            ...
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">E-commerce Platform Masters Multi-language Support</Heading>
              <Text mb={4}>
        ...
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Box bg="white" p={6} borderRadius="md" boxShadow="md">
            <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8} mt={8}>
              <VStack>
                <Text fontWeight="bold" color="orange.600">East Asia</Text>
                <Text>6 Countries</Text>
                <Text>62 Cities</Text>
                <Text>Major Carriers Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Southeast Asia</Text>
                <Text>10 Countries</Text>
                <Text>48 Cities</Text>
                <Text>Major Carriers Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">South Asia</Text>
                <Text>7 Countries</Text>
                <Text>45 Cities</Text>
                <Text>Major Carriers Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Oceania & Pacific</Text>
