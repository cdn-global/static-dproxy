        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Regional Coverage</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Emerging Market Testing</Heading>
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr" }} gap={10} mt={10}>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.600">86%</StatNumber>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.600">1.1M+</StatNumber>
                ...
                <Stat mb={4}>
                  ...
                  {region.states ? (
                    <Flex justify="space-between" align="center">
                      <StatNumber color="orange.600">{region.states}</StatNumber>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">Retail Chain Optimizes Regional Pricing Strategy</Heading>
              <Text mb={4}>
            ...
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">Fintech Startup Perfects Payment Processing</Heading>
              <Text mb={4}>
        ...
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Box bg="white" p={6} borderRadius="md" boxShadow="md">
            <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8} mt={8}>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Brazil</Text>
                <Text>26 States</Text>
                <Text>32 Cities</Text>
                <Text>Major ISPs Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Andean Region</Text>
                <Text>5 Countries</Text>
                <Text>28 Cities</Text>
                <Text>Major ISPs Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Southern Cone</Text>
                <Text>4 Countries</Text>
                <Text>22 Cities</Text>
                <Text>Major ISPs Covered</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Northern Region</Text>
                <Text>4 Countries</Text>
                <Text>12 Cities</Text>
                <Text>Major ISPs Covered</Text>
              </VStack>
