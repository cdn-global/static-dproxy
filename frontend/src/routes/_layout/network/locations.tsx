        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Global Coverage</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Authentic Local Experience</Heading>
            ...
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <Heading as="h3" size="md" color="orange.600">Customizable Selection</Heading>
      ...
      <Box py={16} bg="white">
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr" }} gap={10} mt={10}>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.600">87%</StatNumber>
            ...
            <VStack align="flex-start" spacing={4} bg="gray.50" p={6} borderRadius="md">
              <Stat>
                <StatNumber color="orange.600">5M+</StatNumber>
              ...
              <Box key={index} p={6} bg="white" borderRadius="md" boxShadow="sm">
                <Stat mb={4}>
                  ...
                  <Flex justify="space-between" align="center">
                    <StatNumber color="orange.600">{region.countries}</StatNumber>
                    <Text color="gray.500" fontSize="sm" fontWeight="normal">Countries</Text>
                  </Flex>
                  <Flex justify="space-between" align="center" mt={1}>
                    <StatNumber color="orange.400">{region.cities}</StatNumber>
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.600">Geographic Targeting</Heading>
              <List spacing={3}>
            ...
            <Box p={8} bg="white" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={5} color="orange.600">Control & Integration</Heading>
              <List spacing={3}>
                <ListItem display="flex">
                  <ListIcon as={CheckCircleIcon} color="orange.600" mt={1} />
        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Grid templateColumns={{ base: "1fr", lg: "1fr 1fr" }} gap={8}>
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">Global E-commerce Platform Perfects Localization</Heading>
              <Text mb={4}>
            ...
            <Box p={8} bg="gray.50" borderRadius="md" boxShadow="sm">
              <Heading as="h3" size="md" mb={4} color="orange.600">Travel Industry Leader Optimizes Regional Pricing</Heading>
              <Text mb={4}>
        ...
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Box bg="white" p={6} borderRadius="md" boxShadow="md">
            <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} spacing={4} mt={8}>
              <VStack>
                <Text fontWeight="bold" color="orange.600">North America</Text>
                <Text>3 Countries</Text>
                <Text>182 Cities</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Europe</Text>
                <Text>38 Countries</Text>
                <Text>215 Cities</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Asia-Pacific</Text>
                <Text>25 Countries</Text>
                <Text>178 Cities</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Latin America</Text>
                <Text>20 Countries</Text>
                <Text>94 Cities</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Middle East & Africa</Text>
                <Text>35 Countries</Text>
                <Text>127 Cities</Text>
              </VStack>
              <VStack>
                <Text fontWeight="bold" color="orange.600">Oceania</Text>
