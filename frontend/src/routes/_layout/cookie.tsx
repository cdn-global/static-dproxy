        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              This Cookie Policy explains how theDATAPROXY.com ("we," "us," or "our") uses cookies and similar 
              ...
              <Table variant="simple" size="sm">
                ...
                <Tbody>
                  <Tr>
                    ...
                    <Td>2 years</Td>
                    <Td>
                      <Badge colorScheme="orange">Analytics</Badge>
                    </Td>
                  </Tr>
                  <Tr>
                    <Td>_gid</Td>
          ...
          <Box w="full" id="cookie-management">
            ...
            <UnorderedList pl={6} spacing={2} mb={4}>
              <ListItem><Link color="orange.500" href="https://support.google.com/chrome/answer/95647" isExternal>Google Chrome</Link></ListItem>
              <ListItem><Link color="orange.500" href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" isExternal>Mozilla Firefox</Link></ListItem>
              <ListItem><Link color="orange.500" href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471" isExternal>Apple Safari</Link></ListItem>
              <ListItem><Link color="orange.500" href="https://support.microsoft.com/en-us/help/4027947/microsoft-edge-delete-cookies" isExternal>Microsoft Edge</Link></ListItem>
            </UnorderedList>
            <Text fontSize="md" mb={4}>
            ...
            <UnorderedList pl={6} spacing={2} mb={4}>
              <ListItem><Link color="orange.500" href="http://www.aboutads.info/choices/" isExternal>Digital Advertising Alliance</Link></ListItem>
              <ListItem><Link color="orange.500" href="https://www.youronlinechoices.com" isExternal>Your Online Choices (EU)</Link></ListItem>
            </UnorderedList>
          </Box>
          ...
          <Box w="full" id="contact-us">
            ...
            <Text fontSize="md" mt={4}>
              ...
              deletion requests, please use our dedicated form available at <Link color="orange.500" href="https://thedataproxy.com/privacy-request">thedataproxy.com/privacy-request</Link>.
            </Text>
          </Box>
        </VStack>
      </Container>
