        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            ...
            <Text fontSize="lg">
              ...
              <Link href="/cookie" color="orange.500" textDecoration="underline">
                Cookie Policy
              </Link>{" "}
              and{" "}
              <Link href="/privacy" color="orange.500" textDecoration="underline">
                Privacy Policy
              </Link>.
            </Text>
          </Box>
          ...
          <Box w="full" id="additional-information">
            ...
            <Text fontSize="md">
              ...
              <Link href="http://www.aboutads.info/choices/" color="orange.500" textDecoration="underline" isExternal>
                Digital Advertising Alliance
              </Link>{" "}
              or{" "}
              <Link href="https://www.networkadvertising.org/choices/" color="orange.500" textDecoration="underline" isExternal>
          ...
          <Box w="full" id="contact-us">
            ...
            <Text fontSize="md" mt={4}>
              ...
              <Link href="https://thedataproxy.com/privacy-request" color="orange.500" textDecoration="underline" isExternal>
                thedataproxy.com/privacy-request
              </Link>.
            </Text>
          </Box>
        </VStack>
