        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              Welcome to theDATAPROXY.com! These Terms and Conditions ("Terms") govern your use of our website at thedataproxy.com 
            ...
            <Text fontSize="lg">
              ...
              (collectively, the "Services"). theDATAPROXY.com is committed to ensuring that your experience with us is positive, 
          ...
          <Box w="full" id="changes-to-terms">
            ...
            <Text fontSize="md" mb={4}>
              theDATAPROXY.com reserves the right to amend, modify, or update these Terms at any time without prior notice. All changes 
          ...
          <Box w="full" id="termination-of-access">
            ...
            <Text fontSize="md" mb={4}>
              ...
              violated the rights of theDATAPROXY.com or any third parties, or if we need to comply with legal requirements.
            </Text>
            <Text fontSize="md" mb={4}>
          ...
          <Box w="full" id="limitation-of-liability">
            ...
            <Text fontSize="md" mb={4}>
              To the fullest extent permitted by law, theDATAPROXY.com and its affiliates will not be liable for any indirect, special, 
