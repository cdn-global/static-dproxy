        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              At theDATAPROXY.com, we are committed to maintaining the highest standards of regulatory compliance, 
          ...
          <Box w="full" id="contact-information">
            ...
            <Text fontSize="md" mt={4}>
              ...
              channel at <Link color="orange.500" href="https://thedataproxy.com/report">thedataproxy.com/report</Link>.
            </Text>
          </Box>
        </VStack>
      </Container>
