        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          <Flex justify="space-between" flexWrap="wrap" gap={6}>
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <EmailIcon boxSize={6} color="orange.600" />
              <Heading as="h3" size="md" color="orange.600">Email Us</Heading>
              <Text>Send us a message anytime and we'll respond within 4 business hours.</Text>
              <Link href="mailto:support@thedataproxy.com" color="orange.600">support@thedataproxy.com</Link>
            </VStack>
            
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <PhoneIcon boxSize={6} color="orange.600" />
              <Heading as="h3" size="md" color="orange.600">Call Us</Heading>
              <Text>Speak directly with our team during business hours.</Text>
              <Link href="tel:+18334353873‬" color="orange.600">+1 (833) 435-3873‬</Link>
            </VStack>
            
            <VStack flex="1" minW="280px" align="flex-start" bg="white" p={6} borderRadius="md" spacing={4}>
              <TimeIcon boxSize={6} color="orange.600" />
              <Heading as="h3" size="md" color="orange.600">Business Hours</Heading>
        ...
        <Box maxW="1200px" mx="auto" p={6} px={4}>
          ...
          <Flex justifyContent="center" gap={8} flexWrap="wrap" mt={10}>
            <VStack 
              ...
              minW="300px"
            >
              <Box bg="orange.100" p={4} borderRadius="full">
            ...
            {contactCategories.map((category, index) => (
              ...
              >
                <Box bg="orange.50" p={3} borderRadius="md">
                  <Icon as={category.icon} boxSize={6} color="orange.600" />
                </Box>
        ...
        <Box maxW="1200px" mx="auto" px={4} textAlign="center">
          ...
          <Box bg="orange.50" p={8} borderRadius="md" boxShadow="md">
            <SimpleGrid columns={{ base: 2, md: 4 }} spacing={8}>
              ...
              <VStack>
                <Heading as="h3" size="lg" color="orange.600">3 mins</Heading>
