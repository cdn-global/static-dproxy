        ...
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full">
            <Text fontSize="lg" mb={4}>
              At theDATAPROXY.com, we are committed to protecting your privacy and ensuring the security of your personal information. 
            ...
            <VStack align="start" spacing={6} pl={4} mb={4} w="full">
              ...
              <Box w="full">
                ...
                <Text fontSize="md" mb={2}>
                  ...
                  <Link color="orange.500" href="/cookie" ml={1}>Cookie Policy</Link>.
                </Text>
              </Box>
          ...
          <Box w="full" id="contact-us">
            ...
            <Text fontSize="md" mt={4}>
              ...
              form available at <Link color="orange.500" href="https://thedataproxy.com/privacy-request">thedataproxy.com/privacy-request</Link>.
            </Text>
            <Text fontSize="md" mt={4}>
