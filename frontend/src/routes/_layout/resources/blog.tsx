                  ...
                  >
                    <Box>
                      <HStack mb={4} spacing={3}>
                        <Badge colorScheme="orange" px={3} py={1} borderRadius="full">{post.category || 'Uncategorized'}</Badge>
                        <Flex align="center">
                ...
                <Box bg="white" boxShadow="sm" borderRadius="lg" overflow="hidden" height="100%" cursor="pointer" _hover={{ bg: "gray.50" }} transition="background-color 0.2s">
                  ...
                  <Box p={5}>
                    <HStack mb={3} spacing={3}>
                      <Badge colorScheme="orange" px={2} py={0.5} borderRadius="full">{post.category || 'Uncategorized'}</Badge>
            ...
            <Box>
              <VStack spacing={8} align="stretch">
                ...
                <Box bg="gray.50" p={6} borderRadius="lg" boxShadow="sm">
                  ...
                  <Flex flexWrap="wrap" gap={2}>
                    {popularTags.map((tag, index) => (
                      <Tag key={index} colorScheme={selectedTags.includes(tag) ? "orange" : "orange"} variant={selectedTags.includes(tag) ? "solid" : "subtle"} size="md" borderRadius="full" cursor="pointer" _hover={{ bg: selectedTags.includes(tag) ? "orange.600" : "orange.100" }} onClick={() => handleTagClick(tag)}>{tag}</Tag>
                    ))}
                  </Flex>
                </Box>
                <Box bg="orange.50" p={6} borderRadius="lg" boxShadow="sm">
                  ...
                  <Button colorScheme="orange" width="full" as="a" href="/contact-sales">Contact Us</Button>
                </Box>
              </VStack>
            </Box>
          </Grid>
