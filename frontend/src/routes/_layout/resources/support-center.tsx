        ...
        <Box maxW="1200px" mx="auto" px={4}>
          ...
          {/* <Grid templateColumns={{ base: "1fr", md: "1fr 1fr", lg: "1fr 1fr" }} gap={10} mt={10}> */}
            {/* <VStack align="center" spacing={5} p={8} borderRadius="md" borderWidth="1px" borderColor="gray.200">
              ...
              <Button colorScheme="orange" variant="solid" width="full">
                Start Live Chat
              </Button>
            </VStack>
             */}
              ...
              <Flex key={index} p={6} bg="gray.50" borderRadius="md" boxShadow="sm" align="flex-start">
                ...
                <Box>
                  ...
                  <HStack spacing={8}>
                    ...
                    <Button colorScheme="orange" size="sm" variant="outline">Read Article</Button>
                  </HStack>
                </Box>
              </Flex>
            ))}
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={8}>
            ...
            <Box bg="orange.50" p={8} borderRadius="md">
              ...
              <VStack spacing={4} align="stretch">
                <Button leftIcon={<EmailIcon />} colorScheme="orange" variant="outline" size="lg">
                  Send Email Request
                </Button>
                <Divider my={2} />
