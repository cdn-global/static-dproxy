    ...
    <Box>
      <Container maxW="800px" mx="auto" px={4} py={16} color="gray.800">
        <VStack spacing={8} align="start" w="full">
          ...
          <Box w="full" as="form" onSubmit={handleSubmit}>
            <VStack spacing={6} align="start">
                ...
                <FormControl>
                  ...
                  >
                    <Stack direction="column" spacing={2}>
                      <Radio value="1">I no longer wish to use theDATAPROXY.com services</Radio>
              ...
              <FormControl isRequired>
                ...
                >
                  I understand that theDATAPROXY.com will use the information provided in this form to verify my identity and respond 
          ...
          {/* Introduction */}
          <Box w="full" bg="orange.50" p={6} borderRadius="md">
